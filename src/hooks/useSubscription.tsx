 ...
 export const useSubscription = (): SubscriptionData => {
   ...
   const fetchSubscriptionData = async () => {
     try {
       ...
       if (profileRes.data) {
         setPlanType(profileRes.data.plan_type as "free" | "pro");
       }
   ...
   const canCreateRecipe = planType === "pro" || recipeCount < FREE_RECIPE_LIMIT;
 
   return { planType, canCreateRecipe, recipeCount, loading };
 };
 
 export const isModuleLockedForFree = (moduleName: string, planType: "free" | "pro"): boolean => {
